...
var colorMap = map[rune]color.RGBA{
    ...
    'C': {0, 255, 0, 255},      // Grün
    'E': {0, 0, 255, 255},      // Blau
    'H': {255, 255, 0, 255},    // Gelb
    'I': {255, 0, 255, 255},    // Magenta
    'J': {0, 255, 255, 255},    // Cyan
    'L': {128, 0, 0, 255},      // Dunkelrot
    'M': {0, 128, 0, 255},      // Dunkelgrün
    'N': {0, 0, 128, 255},      // Dunkelblau
    'O': {128, 128, 0, 255},    // Dunkelgelb
    'P': {128, 0, 128, 255},    // Dunkelmagenta
    'R': {0, 128, 128, 255},    // Dunkelcyan
    'S': {192, 192, 192, 255},  // Silber
    'T': {128, 128, 128, 255},  // Grau
    'U': {0, 0, 0, 255},        // Schwarz
    'V': {255, 255, 255, 255},  // Weiß
}
